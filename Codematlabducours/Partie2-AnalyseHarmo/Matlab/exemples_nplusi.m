...
%%% 3 %%%
  ...
  figure(8);
  clf;
  plot(fff,sperec,'r-.*', 'markersize', 1, 'LineWidth', 3);
  hold on;
  plot(fff,spectre,'-o', 'markersize', 1, 'LineWidth', 3);
  xlim([45 55]);
  xlabel('frequence (Hz)','FontSize',20);
  ylabel('amplitude','FontSize',20);
  title('fe=512 Hz, f0=50 Hz, Nsig=1024, pas de 0-padding','FontSize',20);
  ...
  figure(9);
  clf;
  plot(fff,20*log10(sperec),'r-.*', 'markersize', 1, 'LineWidth', 3);
  hold on;
  plot(fff,20*log10(spectre),'-o', 'markersize', 1, 'LineWidth', 3);
  xlim([45 55]);
  ylim([-110 0]);
  xlabel('frequence (Hz)','FontSize',20);
  ...
  figure(10);
  clf;
  plot(fff2,sperec2,'r-.*', 'markersize', 1, 'LineWidth', 3);
  hold on;
  plot(fff2,spectre2,'-o', 'markersize', 1, 'LineWidth', 3);
  xlim([45 55]);
  xlabel('frequence (Hz)','FontSize',20);
  ylabel('amplitude','FontSize',20);
  title('fe=512 Hz, f0=50 Hz, Nsig=1024, NFFT=4096','FontSize',20);
  ...
  figure(11);
  clf;
  plot(fff2,20*log10(sperec2),'r-.*', 'markersize', 1, 'LineWidth', 3);
  hold on;
  plot(fff2,20*log10(spectre2),'-o', 'markersize', 1, 'LineWidth', 3);
  xlim([45 55]);
  ylim([-110 0]);
  xlabel('frequence (Hz)','FontSize',20);
  ylabel('amplitude (dB)','FontSize',20);
