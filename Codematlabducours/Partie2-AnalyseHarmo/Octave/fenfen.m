...
figure(1);
clf;
plot(timi,sigi1,'Linewidth',4,'b');
hold on;
plot(timi,sigi2,'Linewidth',4,'r');
plot(timi,sigi3,'Linewidth',4,'g');
plot(timi,sigi4,'Linewidth',4,'k');
...
figure(2);
clf;
plot(freq,20*log10(abs(fff1)),'Linewidth',4,'b');
hold on;
plot(freq,20*log10(abs(fff2)),'Linewidth',4,'r');
plot(freq,20*log10(abs(fff3)),'Linewidth',4,'g');
plot(freq,20*log10(abs(fff4)),'Linewidth',4,'k');
