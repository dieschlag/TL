...
hold off;
print -depsc2 nstat3_exe1_tfct.eps
...
hold off;
print -depsc2 nstat3_exe2_tfct.eps
...
ylabel('frequence (Hz)','Fontsize',20);
hold off;
print -depsc2 nstat3_exe3_tfct.eps
...
ylabel('frequence (Hz)','Fontsize',20);
hold off;
print -depsc2 nstat3_exe4_tfct.eps
...
ylabel('frequence (Hz)','Fontsize',20);
hold off;
print -depsc2 nstat3_exe5_tfct.eps
