...
if nclasses==2
  ...
  hold off;
  print([preambule "classes.nc" sprintf("%d",nclasses) ".sig2." sprintf("%f",sig2(1)) ".ps"], "-dpsc2");
end;
...
hold off;
print([preambule "donnees.nc" sprintf("%d",nclasses) ".ps"], "-dpsc2");
...
switch simu
  ...
  case 1
    ...
    for cc=1:nclasses
      for dd=1:nchoix
        switch dd
          case 1
            plot(point(1,:),sortiem1(cc,:),[chainea(cc,:) num2str(sig2res(1)) ';']);
          case 2
            plot(point(1,:),sortiem1(cc+nchoix,:),[chaineb(cc,:) num2str(sig2res(2)) ';']);
          case 3
            plot(point(1,:),sortiem1(cc+2*nchoix,:),[chainec(cc,:) num2str(sig2res(3)) ';']);
          case 4
            plot(point(1,:),sortiem1(cc+3*nchoix,:),[chained(cc,:) num2str(sig2res(4)) ';']);
        end;
      end;
    end;
    hold off;
    print([preambule "m1.nc" sprintf("%d",nclasses) ".sig2." sprintf("%f",sig2(1)) ".ps"], "-dpsc2");
    ...
    for cc=1:nclasses
      for dd=1:nchoix
        switch dd
          case 1
            plot(point(1,:),sortiem2(cc,:),[chained(cc,:) num2str(sig2res(1)) ';']);
          case 2
            plot(point(1,:),sortiem2(cc+nchoix,:),[chaineb(cc,:) num2str(sig2res(2)) ';']);
          case 3
            plot(point(1,:),sortiem2(cc+2*nchoix,:),[chainec(cc,:) num2str(sig2res(3)) ';']);
          case 4
            plot(point(1,:),sortiem2(cc+3*nchoix,:),[chained(cc,:) num2str(sig2res(4)) ';']);
        end;
      end;
    end;
    hold off;
    print([preambule "m2.nc" sprintf("%d",nclasses) ".sig2." sprintf("%f",sig2(1)) ".ps"],"-dpsc2");
    ...
    for cc=1:nclasses
      for dd=1:nchoix
        switch dd
          case 1
            plot(point(1,:),sortiem3(cc,:),[chaineb(cc,:) num2str(sig2res(1)) ';']);
          case 2
            plot(point(1,:),sortiem3(cc+nchoix,:),[chaineb(cc,:) num2str(sig2res(2)) ';']);
          case 3
    ...
    hold off;
    print([preambule "m3.nc" sprintf("%d",nclasses) ".sig2." sprintf("%f",sig2(1)) ".ps"],"-dpsc2");
  ...
  case 2
    ...
    hold off;
    print([preambule "m1.nc" sprintf("%d",nclasses) ".mmm." sprintf("%f",mmm) ".ps"], "-dpsc2");
    ...
    hold off;
    print([preambule "m2.nc" sprintf("%d",nclasses) ".mmm." sprintf("%f",mmm) ".ps"],"-dpsc2");
    ...
    hold off;
    print([preambule "m3.nc" sprintf("%d",nclasses) ".mmm." sprintf("%f",mmm) ".ps"],"-dpsc2");
  ...
  case 3
    ...
    hold off;
    print([preambule "m1.nc" sprintf("%d",nclasses) ".nu." sprintf("%f",nu) ".ps"], "-dpsc2");
    ...
    hold off;
    print([preambule "m2.nc" sprintf("%d",nclasses) ".nu." sprintf("%f",nu) ".ps"],"-dpsc2");
    ...
    hold off;
    print([preambule "m3.nc" sprintf("%d",nclasses) ".nu." sprintf("%f",nu) ".ps"],"-dpsc2");
